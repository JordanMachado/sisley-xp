...
-(void)configureView2 {
    self.productText2= [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"recolte-text1"]];
    self.productText2.frame = CGRectMake(self.view.bounds.size.width*2+ 10,self.scrollView.bounds.size.height/2+40,self.productText2.bounds.size.width/ 1.8,self.productText2.bounds.size.height/ 1.8);
